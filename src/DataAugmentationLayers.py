...
cifar100_img_augmentation = [
  ...
  # layers.experimental.preprocessing.RandomTranslation(height_factor=0.1, width_factor=0.1), # new for 32x32x3 training
  # layers.experimental.preprocessing.RandomContrast(factor=0.1) # new for 32x32x3 training
]
